  ...
  return (
    <section className="bg-white py-20">
      <div className="mx-auto max-w-2xl px-6">
        ...
        <h1 className="font-heading text-3xl font-extrabold text-navy-black sm:text-4xl">
        ...
        <p className="mt-8 text-sm text-slate">
          ...
          <a href="mailto:connect@mnblockchain.org" className="font-semibold text-navy-black underline">
