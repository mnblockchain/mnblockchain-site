  ...
  if (state?.success) {
    return (
      <div className="rounded-2xl border border-brand-blue bg-cloud p-8">
        <p className="font-heading font-bold text-navy-black">Message received!</p>
    ...
    <form action={action} className="space-y-4">
      ...
      <div>
        ...
        <textarea
          ...
          required
          rows={5}
          className="w-full resize-none rounded-xl border border-slate-300 px-4 py-3 text-sm focus:border-navy-black focus:outline-none"
        />
      </div>
      ...
      <button
        type="submit"
        disabled={pending}
        className="rounded-full bg-bitcoin-orange px-7 py-3.5 text-sm font-bold uppercase tracking-wide text-navy-black transition-colors hover:bg-bitcoin-orange/80 disabled:opacity-50"
      >
